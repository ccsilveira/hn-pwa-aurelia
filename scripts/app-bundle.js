...
define('resources/elements/offline',["require", "exports", "aurelia-framework"], function (require, exports, aurelia_framework_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Offline = (function () {
        function Offline() {
        }
        Offline.prototype.valueChanged = function (newValue, oldValue) {
        };
        return Offline;
    }());
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Object)
    ], Offline.prototype, "value", void 0);
...
define('text!resources/elements/offline.html', ['module'], function(module) { module.exports = "<template><h1>The site is offline :(</h1><p>Cache-sw</p><p></p></template>"; });
